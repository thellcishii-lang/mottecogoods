...
export default function PrivacyPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-12 prose prose-gray">
      ...
      <p>
        mottECOグッズ.com the合同会社（以下「当社」といいます。）は、当社の提供するサービス（以下「本サービス」といいます。）における、ユーザーについての個人情報を含む利用者情報の取扱いについて、以下のとおりプライバシーポリシー（以下「本ポリシー」といいます。）を定めます。
      </p>
      ...
      <h3>(3) 本サービスの利用にあたって当社が収集する情報</h3>
      <p>
      ...
      <ul>
        <li>提携先：（該当なし／記入が必要）</li>
        <li>上記提携先のプライバシーポリシーのURL：（該当なし／記入が必要）</li>
        <li>上記提携先のオプトアウト（無効化）URL：（該当なし／記入が必要）</li>
      </ul>
      <p>
        4-2 本サービスには以下の情報収集モジュールが組み込まれています。これに伴い、以下のとおり情報収集モジュール提供者（日本国外にある者を含みます。）への利用者情報の提供を行います。
      </p>
      <ul>
        <li>情報収集モジュールの名称：（該当なし／記入が必要）</li>
        <li>情報収集モジュールの提供者：（該当なし／記入が必要）</li>
        <li>提供される利用者情報の項目：（該当なし／記入が必要）</li>
        <li>提供の手段・方法：（該当なし／記入が必要）</li>
        <li>上記提供者における利用目的：（該当なし／記入が必要）</li>
        <li>上記提供者における第三者提供の有無：（該当なし／記入が必要）</li>
        <li>上記提供者のプライバシーポリシーのURL：（該当なし／記入が必要）</li>
      </ul>
      ...
      <ul>
        <li>共同して利用される個人情報の項目：（該当なし／記入が必要）</li>
        <li>共同して利用する者の範囲：（該当なし／記入が必要）</li>
        <li>共同して利用する者の利用目的：（該当なし／記入が必要）</li>
        <li>個人情報の管理について責任を有する者の氏名または名称：（該当なし／記入が必要）</li>
      </ul>
      ...
      <ul>
        <li>住所：〒357-0123 埼玉県飯能市中藤下郷23-21</li>
        <li>mottECOグッズ.com the合同会社</li>
        <li>個人情報取扱責任者：石井康仁</li>
        <li>連絡先：050-5891-3992</li>
      </ul>
